...
namespace Microsoft.Owin.Security.Paipai.Provider
{
    ...
    /// </summary>
    public class PaipaiAccountApplyRedirectContext : BaseContext<PaipaiAccountAuthenticationOptions>
    {
        /// <summary>
        ...
        public PaipaiAccountApplyRedirectContext(IOwinContext context, PaipaiAccountAuthenticationOptions options,
